...
//				debug = true;
		...
		try
		{
			pfg.graphic.TimestampedList listes = null;
...
//				special("Debug activé");
			...
			pfg.graphic.DebugTool debugTool = null;
			XY_RW center = null;
			Display buffer = null;
			...
			if(filename != null)
			{
				try
				{
					...
					listes = (pfg.graphic.TimestampedList) ois.readObject();
					ois.close();
				}
				...
				debugTool = pfg.graphic.DebugTool.getDebugTool(defaultCenter, center, null, "reader.conf", "default");
